...
def make_averaged(original_function, total_samples=1000):
    ...
    def average_func(*args):
        lis=[original_function(*args) for i in range(total_samples)]
        return sum(lis)/total_samples
    return average_func
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    #"*** YOUR CODE HERE ***"
    lis=[make_averaged(roll_dice,total_samples)(i,dice) for i in range(1,11)]
    return lis.index(max(lis))+1
    # END PROBLEM 9
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    temp=score+tail_points(opponent_score)
    tail_score=next_perfect_square(temp)-score if perfect_square(temp) else temp-score
    return num_rolls if tail_score<threshold else 0# Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    wish=1-(5/6)**num_rolls+(5/6)**num_rolls * 4*num_rolls
    max:5;thresh=9
    """
    # BEGIN PROBLEM 12

    return square_strategy(score,opponent_score,threshold=9,num_rolls=5)  # Remove this line once implemented.
    # END PROBLEM 12
